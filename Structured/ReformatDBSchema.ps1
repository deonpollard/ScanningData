...
if ($Drop.length -lt 2) {
    ...
    $Drop = "C:\Users\deonp\MySQLSchema.csv"
	}
$OPath = $Drop
...
$Increment=0
 foreach($i in $New) 
      ...
      $obj = new-object PSObject
        ...
        $obj | add-member -membertype NoteProperty -name "SrcName" -value $DBName
